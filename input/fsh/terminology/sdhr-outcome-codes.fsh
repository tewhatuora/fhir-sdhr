...
* #shdr-facility-participate-deny "SDHR Facility Participate Deny" "This code is used when the patient has opted out of participating in the Shared Digital Health Record service at a specific facility."
