Instance: OperationOutcomeParticipationStatusInvalidPatient
InstanceOf: OperationOutcome
Description: "Example OperationOutcome for an invalid patient reference in the participation status operation."
Usage: #example
